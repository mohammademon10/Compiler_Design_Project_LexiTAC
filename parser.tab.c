...
{
      15,     0,    -1,    -1,    15,    16,    -1,     3,     5,    17,
      12,    -1,     1,    12,    -1,    17,     6,    18,    -1,    17,
       7,    18,    -1,    18,    -1,    18,     8,    19,    -1,    18,
       9,    19,    -1,    19,    -1,    10,    17,    11,    -1,     4,
      -1,     3,    -1,     7,    19,    -1
};
...
{
       0,    88,    88,    90,    94,   104,   108,   115,   122,   126,
     133,   140,   144,   145,   146,   147
};
#endif
...
static const char *const yytname[] =
{
  ...
  "MINUS", "MUL", "DIV", "LPAREN", "RPAREN", "NEWLINE", "UMINUS",
  "$accept", "program", "stmt", "expr", "term", "factor", 0
};
#endif
...
{
       2,     0,     1,     0,     0,     3,     5,     0,    14,    13,
       0,     0,     0,     8,    11,    15,     0,     0,     0,     4,
       0,     0,    12,     6,     7,     9,    10
};
...
{
     -12,    15,   -12,     2,    16,   -12,   -12,    -2,   -12,   -12,
      -2,    -2,    -3,    11,   -12,   -12,     6,    -2,    -2,   -12,
      -2,    -2,   -12,    11,    11,   -12,   -12
};
...
{
      15,     8,     9,    17,    18,    10,    23,    24,    11,    19,
      25,    26,    17,    18,     6,     2,     3,    22,     4,    20,
      21,     7,     0,    16
};

static const yytype_int8 yycheck[] =
{
      10,     3,     4,     6,     7,     7,    17,    18,    10,    12,
      20,    21,     6,     7,    12,     0,     1,    11,     3,     8,
       9,     5,    -1,    11
};
...
{
       0,    15,     0,     1,     3,    16,    12,     5,     3,     4,
       7,    10,    17,    18,    19,    19,    17,     6,     7,    12,
       8,     9,    11,    18,    18,    19,    19
};
...
#line 95 "parser.y"
    {
            ...
            int idx = sym_index((yyvsp[(1) - (4)].str));           /* $1 is already the id string  */
            /* Walk symtab to find by id */
            char lhs[8];
            strcpy(lhs, (yyvsp[(1) - (4)].str));                   /* $1 is id string from lexer   */
            emit(lhs, (yyvsp[(3) - (4)].str), NULL, NULL);
...
#line 148 "parser.y"
    {
            char *t = make_tmp();
            emit(t, "-", (yyvsp[(2) - (2)].str), NULL);   /* unary minus as: t = - x */
            free((yyvsp[(2) - (2)].str));
            (yyval.str) = t;
        ;}
    break;
